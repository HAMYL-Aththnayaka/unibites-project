...
const Navbar = ({setShowLogin}) => {
  ...
  const {getaTotalCartAmmount,token,setToken} =useContext(StoreContext)
    ...
    <div className='navbar'>
      ...
      <ul className="navbar-menu">
        ...
        <Link to='/help' onClick={()=>{
          setMenu('Helping-Hand')
          }} className={menu === 'Helping-Hand'?'active':''}>Helping Hand</Link>
      </ul>
      <div className="navbar-right">
        ...
        <div className="navbar-search-icon">
          ...
          <div className={getaTotalCartAmmount()===0?'':'dot'}></div>
        </div>
