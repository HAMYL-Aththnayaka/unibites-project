...
const styles = StyleSheet.create({
  ...
  backText: { color: '#ea580c', fontWeight: 'bold', marginRight: 20 },
  title: { fontSize: 24, fontWeight: '900', color: '#111827' },
  listContent: { padding: 20 },
  cartItem: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#f9fafb', padding: 12, borderRadius: 16, marginBottom: 12 },
  itemImage: { width: 60, height: 60, borderRadius: 12 },
  itemInfo: { flex: 1, marginLeft: 12 },
  itemName: { fontSize: 16, fontWeight: 'bold' },
  itemPrice: { color: '#6b7280', marginTop: 4 },
  freeLabel: { color: '#10b981', fontWeight: 'bold', marginTop: 4 },
  removeBtn: { padding: 8 },
  ...
  totalLabel: { fontSize: 18, color: '#374151' },
  totalPrice: { fontSize: 20, fontWeight: '900', color: '#111827' },
  checkoutBtn: { backgroundColor: '#ea580c', padding: 20, borderRadius: 16, alignItems: 'center' },
